...
export const gifts = [
    { key: 'q', name: '樱花美白面膜', alias: '樱花面膜', image: '/images/01.jpg', description: '把可爱的春天提前送给你' },
    { key: 'w', name: '腾讯视频一个季度VIP', alias: 'VIP', image: '/images/2.png', description: '忙着追剧，也要记得想我' },
    { key: 'e', name: '心心相吸手链一对', alias: '手链套装', image: '/images/03.jpg', description: '将你我系在一起' },
    { key: 'r', name: '520红包', alias: '520', image: '/images/6.png', description: '“想给你唱一百首情歌”' },
    { key: 't', name: '朝朝暮暮香薰', alias: '香薰', image: '/images/05.jpg', description: '「日月星河，朝朝暮暮」' },
    { key: 'y', name: '旋转木马香水', alias: '木马香水', image: '/images/06.jpg', description: '“是梦幻，是童话，是无需长大”' },
    { key: 'u', name: '指定口红礼品', alias: '口红', image: '/images/1.png', description: '“口红！买！”' },
    { key: 'i', name: '故宫美妆套装', alias: '故宫美妆', image: '/images/08.jpeg', description: '「春与美妆，皆动人」' },
];
